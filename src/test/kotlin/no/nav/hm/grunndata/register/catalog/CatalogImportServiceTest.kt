...
class CatalogImportServiceTest(
    ...
    @Test
    fun testCreateCatalogImportResult() {
        runBlocking {
            val firstImport =
            ...
            val createCatalogImportResult =
                catalogImportService.createCatalogImportResult(firstImport.map { it.toEntity() })
            ...
            val createCatalogImportResult2 = catalogImportService.createCatalogImportResult(mapped)
