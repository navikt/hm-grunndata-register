...
class TechLabelRegistrationRepositoryTest(private val techLabelRegistrationRepository: TechLabelRegistrationRepository) {
    ...
    fun crudTest() {
        val techLabel = TechLabelRegistration(id = UUID.randomUUID(), identifier = "HMDB-20815", label = "Høyde", guide="Høyde", definition = "Høyde",
            isoCode = "09070601", type = TechLabelType.N, unit = "cm", sort = 1, options = setOf("1", "2", "3")
        )
        runBlocking {
            ...
            found.type shouldBe TechLabelType.N
            found.unit shouldBe "cm"
            found.definition shouldBe "Høyde"
            found.sort shouldBe 1
            found.options shouldBe setOf("1", "2", "3")
            found.section shouldBe null
            found.isoCode22 shouldBe null
            val updated = techLabelRegistrationRepository.update(found.copy(guide = "Høyde eller noe",
                section = "Høyde",
                required = true,
                isoCode22 = "09070602",
