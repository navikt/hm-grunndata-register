...
@MicronautTest
class SeriesControllerApiTest(private val apiClient: SeriesControllerApiClient,
        ...
        runBlocking {
            ...
            val seriesRegistrationDTO = SeriesRegistrationDTO(
                ...
                seriesData = SeriesData(media = setOf(
                    MediaInfoDTO(uri = "http://example.com", type = MediaType.IMAGE, text = "image description",
            ...
            val updated = apiClient.updateSeries(jwt, read.id, read.copy(title = "new title", isoCategory = "111111", text = "new text"))
