...
class DuplicateHmsnrSupplierIdHandlerController(private val productRegistrationRepository: ProductRegistrationRepository,
                                                private val productAgreementRegistrationRepository: ProductAgreementRegistrationRepository,
                                                private val productRegistrationService: ProductRegistrationService) {

    @Get("/")
    suspend fun findDuplicateHmsnr(): List<ProductIdHmsArtNr> {
        val duplicates = productRegistrationRepository.findAllDuplicateHmsArtnrSupplierId()
    ...
    companion object {
        private val LOG = org.slf4j.LoggerFactory.getLogger(DuplicateHmsnrSupplierIdHandlerController::class.java)
    }
}