...
class SeriesImportSyncRiver(
    ...
    private fun mapAdminStatus(status: SeriesStatus): AdminStatus =
        if (status == SeriesStatus.ACTIVE) AdminStatus.APPROVED else AdminStatus.PENDING
