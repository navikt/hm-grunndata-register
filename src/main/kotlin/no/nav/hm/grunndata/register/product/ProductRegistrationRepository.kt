...
interface ProductRegistrationRepository :
    ...
    @Query("SELECT * FROM product_reg_v1 WHERE (accessory = true OR spare_part = true) AND product_data->'attributes'->'compatibleWith'->'seriesIds' @> to_jsonb(:seriesUUID::text)")
