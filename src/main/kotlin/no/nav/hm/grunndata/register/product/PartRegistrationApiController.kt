...
@Controller(PartsRegistrationApiController.API_V1_PART_REGISTRATIONS)
@Tag(name = "HMS-user and admin Parts")
class PartsRegistrationApiController(
    private val productRegistrationService: ProductRegistrationService,
    private val productDTOMapper: ProductDTOMapper,
) {
    companion object {
        const val API_V1_PART_REGISTRATIONS = "/common/api/v1/part/registrations"
