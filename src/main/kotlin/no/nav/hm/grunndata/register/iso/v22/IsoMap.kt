...
data class IsoMap(
    ...
    val mapEnum: IsoMapEnum = IsoMapEnum.SAME,
    val code22: String?=null,
    val created: LocalDateTime = LocalDateTime.now(),
)

enum class IsoMapEnum(val code: String, val textNo: String) {
    ...
    companion object {
        fun fromCode(code: String): IsoMapEnum? = entries.find { it.code == code }
    }
}
