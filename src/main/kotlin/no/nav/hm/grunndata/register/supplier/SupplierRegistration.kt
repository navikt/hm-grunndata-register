...
data class SupplierRegistrationDTO(
    ...
    private fun SupplierData.toInfo(): SupplierInfo =
        SupplierInfo(
            address = address,
            postNr = postNr,
...
fun SupplierRegistration.toDTO(): SupplierRegistrationDTO =
...
fun SupplierRegistrationDTO.toEntity(): SupplierRegistration =
